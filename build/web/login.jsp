...
<a class='w3schools-logo notranslate' href=''>TechSecure<span class='dotcom'>.com</span></a>
  ...
  <h2>Login</h2>
  <form action="EmailSendingServlet" style="max-width:500px;margin:auto" method="POST">
  <div class="input-container">
                <i class="fa fa-user icon"></i>
                <input class="input-field" type="text" placeholder="User ID" name="name" id="name" required="required"></td></tr>
                </div>
      <div class="input-container">
