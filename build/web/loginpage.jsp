 <%-- 
    Document   : loginpage
    Created on : Jun 2, 2020, 10:06:01 AM
    Author     : PRASANNA
--%>
    ...
    <div class="w3-bar w3-left" style="width:100%;overflow:hidden;height:44px">
      ...
      <a href='index.jsp' class='topnav-icons fa fa-home w3-left w3-bar-item w3-button' title='Home'></a>
       ...
       <a class="w3-bar-item w3-button w3-right" target="_blank" href='registration.jsp'>Registration</a>
        ...
        <form action="acclogin.jsp">
        <table>
            <tr><td> <input type="submit" class="btn" value="    Money Transaction    "></td> </tr></table></form><form><table><tr><td> <input type="submit" class="btn" value="    Online Shoping    "></td></tr></table></form>>
            <form><table><tr> <td><input type="submit" class="btn" value="    UserDetail     "></td></tr></table></form><form><table><tr><td><input type="submit" class="btn" value="      Prepaid          "></td></tr></table></form>
