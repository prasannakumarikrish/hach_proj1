<%-- 
    Document   : index
    Created on : May 22, 2020, 10:57:24 AM
    Author     : PRASANNA
--%>
...
<a class='w3schools-logo notranslate' href=''>TechSecure<span class='dotcom'>.com</span></a>
  ...
  <div style="overflow:auto;">
    <div class="w3-bar w3-left" style="width:100%;overflow:hidden;height:44px">
      ...
      <a href='count_rows.jsp' class='topnav-icons 	fa fa-cubes w3-left w3-bar-item w3-button'  title='Number of Reg'></a>
      <a href='chart.jsp' class='topnav-icons 	fa fa-area-chart w3-left w3-bar-item w3-button'  title='Number of Reg'></a>
 ...
 -->
  ...
  <p>Scroll Up and Down this page to see the parallax scrolling effect.</p>
    ...
    <!--<h2>Social Media Marketing Is Fleeting</h2>
    <p class="b">In the early days of social marketing, there was little competition for the dollar—not so today. For example, you can spend thousands of dollars on a Facebook ad campaign and, sometimes, get no return on your investment. By its very nature, social media is a short attention span media—it is much harder to get someone's attention with a Tweet then it was to get someone's attention with a newspaper ad. That's because ad headlines and copy are harder to write on Twitter or Instagram. </p>-->
<div class="parallax"> </div>
<div style="height:500px;background-color:#D3D3D3;color:#282828;">
<h2>REGISTRATION THE FORM</h2>
<form onSubmit = "return checkPassword(this)" action="hack_proj1" name="form1"  method="POST"  accept-charset="UTF-8" style="max-width:500px;margin:auto">
            <table>
                <div class="input-container">
                <i class="fa fa-user icon"></i>
                <input class="input-field" type="text" placeholder="Name" name="name" id="name" required="required"></td></tr>
                </div>
                <div class="input-container">
                <i class="fa fa-phone-square icon"></i>
                <input class="input-field" type="number" placeholder="mobile number" name="mobile" id ="mobile" required="required"></td></tr>
                 </div>
                <div class="input-container">
                <i class="fa fa-envelope icon"></i>
                <input class="input-field" type="email" placeholder="E-Mail" name="email" id="email" required="required"></td></tr>
                </div>
                <div class="input-container">
                <i class="fa fa-key icon"></i>
                <input class="input-field" type="password" placeholder="Password" name="password" id="password" required="required"></td></tr>
                </div>
                <div class="input-container">
                <i class="fa fa-key icon"></i>
                <input class="input-field" type="password" placeholder="Conform password" name="password1" id="password1" required="required"></td></tr>
                </div>
                </table>
