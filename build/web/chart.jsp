<%-- 
    Document   : chart
    Created on : Jun 6, 2020, 11:07:03 PM
    Author     : PRASANNA
--%>

<%-- 
    Document   : chart
    Created on : Jun 6, 2020, 1:27:12 PM
    Author     : PRASANNA
--%>
...
try{
	...
	//Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/hackathon?zeroDateTimeBehavior=convertToNull", "root", "");
	...
	while(resultSet.next()){
		...
		map = new HashMap<Object,Object>(); map.put("x", Double.parseDouble(xVal)); map.put("x",Double.parseDouble(yVal)); list.add(map);
