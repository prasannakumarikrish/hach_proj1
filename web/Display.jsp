<%-- 
    Document   : Display
    Created on : Jun 6, 2020, 11:41:01 PM
    Author     : PRASANNA
--%>
...
<a class='w3schools-logo notranslate' href=''>TechSecure<span class='dotcom'>.com</span></a>
  ...
  <h2><font color="green">Data updated successfully!!!</font></h2><br>
  <center>
    <form>
        <table>
  <!--<table border="1" width="30%" height="30%">-->
      <input type="hidden" name="id" value=${idaff}>
 <!-- <tr><th><font color='Red'>EMP ID</font></th><th><font color='Red'>EMP NAME</font></th><th><font color='Red'>SALARY</font></th></tr>-->
<%
    try{
        String id=request.getParameter("id");
        int reg_id=Integer.valueOf(id);
...
//ResultSet rs=stmt.executeQuery("SELECT *  FROM customer WHERE reg_id=-556352414");
  ...
  %>
<tr><td><div class="btn">User Name</div></td><td>:</td><td><b><%=Username%></b></td></tr>
<tr><td><div class="btn">User RegId</div></td><td>:</td><td><b><%=Salary%></b></td></tr>
<tr><td><div class="btn">User E-Mail</div></td><td>:</td><td><b><%=Useremail%></b></td></tr>
<tr><td><div class="btn">User Mobile No</div></td><td>:</td><td><b><%=Userphone%></b></td></tr>
<tr><td><div class="btn">User password</div></td><td>:</td><td><b><%=pass%></b></td></tr>
<tr><td><div class="btn">Registration date</div></td><td>:</td><td><b><%=date%></b></td></tr>
<%
  }
}catch(Exception e)
{
...
imgData = image.getBytes(1,(int)image.length());
  ...
  %>
<tr><td><div class="btn">User Name</div></td><td>:</td><td><b><%=Username%></b></td></tr>
<tr><td><div class="btn">User Account No</div></td><td>:</td><td><b><%=Useremail%></b></td></tr>
<tr><td><div class="btn">IFSC</div></td><td>:</td><td><b><%=date%></b></td></tr>
<tr><td><div class="btn">Account Password</div></td><td>:</td><td><b><%=Salary%></b></td></tr>
<!--<tr><td><div class="btn">User Mobile No</div></td><td>:</td><td><b><//%=Userphone%></b></td></tr>-->
<tr><td><div class="btn">Registration Type</div></td><td>:</td><td><b><%=pass%></b></td></tr>
