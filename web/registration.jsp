<%-- 
    Document   : index
    Created on : May 21, 2020, 1:49:48 PM
    Author     : PRASANNA
--%>
   ...
   <footer class="footer-distributed">
    ...
    <center>
       <!-- <h1>Registration Form</h1>
        <form action="hack_proj1" name="form1"  method="POST"  accept-charset="UTF-8" >
            
            <table>
                <tr><td>Full Name:</td><td><input type="text" name="name" id="name" required="required"></td></tr>
                <tr><td>Mobile:</td><td><input type="number" name="mobile" id ="mobile" required="required"></td></tr>
                <tr><td>E-Mail:</td><td><input type="email" name="email" id="email" required="required"></td></tr>
                <!--<tr><td>Date:</td><td><input type="date" name="date"></td></tr>-->
               <!-- <tr><td>Registration ID:</td><td><input type="password" name="reg_id" id="reg_id" required="required"></td></tr>-->
               <!-- </table>
