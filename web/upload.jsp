<%-- 
    Document   : upload
    Created on : May 30, 2020, 7:21:59 PM
    Author     : PRASANNA
--%>
...
padding:10px;
 ...
 <center>
    <form method="post" action="yeah!" enctype="multipart/form-data">
         
        <table>
             <tr><td>
              <div class="input-container">
                <i class="fa fa-id-card icon"></i>
                <input class="input-field" type="text" placeholder="Account number" name="acc" id="acc" required="required">
                </div>
                     </td></tr><tr></tr>
             <tr></tr>
                     <tr></tr>
             ...
             <tr><td>
              <div class="input-container">
                ...
                <input class="input-field" type="text" placeholder="IFSC" name="ifsc" id="ifsc" required="required">
                </div>
                     </td></tr>
                      <tr></tr>
                     <tr></tr>
             ...
             <tr><td>
                    <div class="input-container">
                <i class="fa fa-key icon"></i>
                <input class="input-field" type="password" placeholder="Conform Password" name="password1" id="password1" required="required">
                </div> 
             </td></tr> 
             </td></tr>
                      <tr></tr>
...
<select name="reg_type" class="combo">
...
<option value="Others">Others</option>
           ...
           <tr><td> <div font-color="red">*must be your image will be in 16Kpb</td></div></tr>
           <tr></tr>
                     <tr></tr>
                     <tr></tr>
                     <tr></tr>
            ...
            <tr><td><input type="submit" class="btn" size="20px" value="Submit"></td></tr>
             </table>
            </form>
 </center>
